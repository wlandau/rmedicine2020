...
* Simulation:
    1. Simulate time to event data from each arm (1 treatment and 1 placebo) from probability distributions.
...
```{r, eval = FALSE}
r_make()
#> ▶ dynamic patients_100
#> > subtarget patients_100_0b3474bd
#> > subtarget patients_100_b2a5c9b8
# ...
#> ■ finalize patients_100
#> ▶ dynamic patients_200
...
#> ▶ dynamic models_300
#> ▶ dynamic models_400
#> ▶ target summaries_100
#> ▶ target summaries_200
#> ▶ target summaries_300
...
* The largest sample size should be the most powerful, and some of the MCMCs did not converge.
* We need to run more trial simulations and MCMC samples.
* The code at <https://github.com/wlandau/rmedicine2020> scaled up and configured to run targets in parallel on a Sun Grid Engine cluster.
    * Execute `run.sh` or `run.R` to deploy the pipeline.
...
## After scaled-up computation on a cluster
...
#>   prob_success median max_psrf patients_per_arm mean_control mean_treatment
#>          <dbl>  <dbl>    <dbl>            <dbl>        <dbl>          <dbl>
#> 1        0.4    0.999     1.02              100           20             10
#> 2        0.388  0.998     1.02              200           20             10
#> 3        0.39   1.00      1.02              300           20             10
#> 4        0.4    0.996     1.03              400           20             10
```
