...
* Decision: graduate to phase 3 if Prob(hazard ratio (of discharge) > 1.5) > 0.6 at the end of the study.
* Simulation:
...
#> 1        0.996  2.36      1.03              100           20             10
#> 2        0.001  0.997     1.02              100           20             20
```
...
#>          <dbl>  <dbl>    <dbl>            <dbl>        <dbl>          <dbl>
#> 1        0.996  2.36      1.03              100           20             10
#> 2        0.503  1.56      1.03              100           20             15
#> 3        0.001  0.997     1.02              100           20             20
```
