...
* Goal: understand the operating characteristics of the trial under different effect size scenarios.
* Patient population: hospitalized patients with moderate symptoms.
* Endpoint: days until discharge from the hospital.
* Decision: go to phase 3 if Prob(hazard ratio (of discharge) > 1.5) > 0.6 at the end of the study.
* Simulation:
